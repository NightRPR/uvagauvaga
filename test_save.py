...
menu_theme = pygame.mixer.Sound('just_test.mp3')
pause_theme = pygame.mixer.Sound('Not_mario.mp3')
dungeon_theme = pygame.mixer.Sound('dungeon.mp3')
forest_theme = pygame.mixer.Sound('forest.mp3')
attack_sound = pygame.mixer.Sound('oof.mp3')
lose_theme = pygame.mixer.Sound('lose.mp3')
win_theme = pygame.mixer.Sound('win.mp3')
button_sound = pygame.mixer.Sound('succ.mp3')
door_open = pygame.mixer.Sound('door.mp3')
collect_item = pygame.mixer.Sound('WOO.mp3')
fight_theme = pygame.mixer.Sound('combat01.mp3')
mwin_theme = pygame.mixer.Sound('mini_win.mp3')
